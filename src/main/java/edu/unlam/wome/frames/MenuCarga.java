...
public class MenuCarga extends JFrame {
	...
	public MenuCarga(final Cliente cliente) {
		...
		barraCargando.setIcon(new ImageIcon(MenuCarga.class
				.getResource("/edu/unlam/wome/frames/Barra.png")));
		...
		lblBarraCarga.setIcon(new ImageIcon(MenuCarga.class
				.getResource("/edu/unlam/wome/frames/BarraCarga.png")));
